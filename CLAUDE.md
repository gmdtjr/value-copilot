...
[AI 분석] ("AI 분석" 버튼)
  ...
  → Claude Sonnet → Thesis 4섹션 초안 (실제 수치 기반)
    ↓
[피드백 루프] (선택, 반복 가능)
  사람 피드백 → Claude Sonnet → 수정된 Thesis (기존 수치 유지)
    ↓
[Confirm] (사람만)
...
Agent      Anthropic API
           - claude-sonnet-4-6: thesis / report / break_monitor / briefing / discovery / portfolio-review
           - claude-haiku-4-5-20251001: SEC 공시 섹션 요약 (비용 절감)
           SKILL.md 기반 스킬 시스템
           Scratchpad: .scratchpad/*.jsonl (모든 Claude 호출 로그)
           ref: virattt/dexter
